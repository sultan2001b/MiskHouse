...
sami = fullstackdeveloper.students.create(f_name: "sami", l_name: "aldahlawi", gender: "male", email: "email@email.com", mobile: "0501231234", img: imgage_path, bio: "bio !!",user_id:1)
mansour = becomeiosdeveloper.students.create(f_name: "masour", l_name: "alsqian", gender: "male", email: "email@email.com", mobile: "0501231234", img: imgage_path, bio: "bio !!",user_id:2)
sultan = becomeblockchaindeveloper.students.create(f_name: "sultan", l_name: "alsamaani", gender: "male", email: "email@email.com", mobile: "0501231234", img: imgage_path, bio: "bio !!",user_id:3)
